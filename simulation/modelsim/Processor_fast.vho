...
SIGNAL \Reg_B|Q\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \Reg_A|Q\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \KEY~combout\ : std_logic_vector(1 DOWNTO 0);
SIGNAL \SW~combout\ : std_logic_vector(9 DOWNTO 0);
SIGNAL \ALT_INV_SW~combout\ : std_logic_vector(9 DOWNTO 4);
...
\ALT_INV_SW~combout\(4) <= NOT \SW~combout\(4);
...
\Reg_A|Q[0]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Reg_A|Q[0]~feeder_combout\ = \SW~combout\(0)
...
PORT MAP (
	clk => \KEY~combout\(0),
	datain => \Reg_A|Q[0]~feeder_combout\,
	ena => \ALT_INV_SW~combout\(4),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \Reg_A|Q\(0));
...
\Reg_A|Q[1]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Reg_A|Q[1]~feeder_combout\ = \SW~combout\(1)
...
PORT MAP (
	clk => \KEY~combout\(0),
	datain => \Reg_A|Q[1]~feeder_combout\,
	ena => \ALT_INV_SW~combout\(4),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \Reg_A|Q\(1));
...
-- Equation(s):
-- \Reg_A|Q[2]~feeder_combout\ = \SW~combout\(2)
...
\Reg_A|Q[3]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \Reg_A|Q[3]~feeder_combout\ = \SW~combout\(3)
...
PORT MAP (
	clk => \KEY~combout\(0),
	datain => \Reg_A|Q[3]~feeder_combout\,
	ena => \ALT_INV_SW~combout\(4),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \Reg_A|Q\(3));
...
-- Equation(s):
-- \Reg_B|Q[0]~feeder_combout\ = \SW~combout\(5)
...
-- Equation(s):
-- \Reg_B|Q[1]~feeder_combout\ = \SW~combout\(6)
...
-- Equation(s):
-- \Reg_B|Q[2]~feeder_combout\ = \SW~combout\(7)
